...
class ParcelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create parcel" do
    assert_difference("Parcel.count") do
      post parcels_url, params: { parcel: { destination: @parcel.destination, from: @parcel.from, recipient_address: @parcel.recipient_address, recipient_name: @parcel.recipient_name, totalcost: @parcel.totalcost, weight: @parcel.weight } }
    end
  ...
  test "should update parcel" do
    patch parcel_url(@parcel), params: { parcel: { destination: @parcel.destination, from: @parcel.from, recipient_address: @parcel.recipient_address, recipient_name: @parcel.recipient_name, totalcost: @parcel.totalcost, weight: @parcel.weight } }
